	...
	<div class="col-sm-12">
		<div class="ibox">
			<div class="ibox-title">
				<h3> <?php echo trans('expense_report'); ?> </h3>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	function TableDataColums(){
		...
		// { "title": $_lang.serial_no,"class": "text-center",
			...
			// }
		// },
		{ "title": $_lang.expense_purpose,"class": "text-center", data : 'dr_account' },
		{ "title": $_lang.prayer_name,"class": "text-center", data : 'payer_name' },
		{ "title" : $_lang.expense_status,"class": "text-center", data : 'account_status' },
		{ "title": $_lang.payment_method,"class": "text-center", data : 'payment_method' },
		{ "title": $_lang.expense_amount,"class": "text-center account_amount", data : 'amount' }, 
	...
	function ExpenseFilter(FilterType) {
		...
		AS.Http.GetDataTable('#expenseReportTable',TableDataColums(),{ action : "GetExpenseReportData",account_name : ac_name, between_action : "date", from_data : start, to_data : end, date_range : true, account_for : expenseFor, store_id : businessLocation},"pos/filter/",FilterType,false);
	}
