...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <h2><?php echo trans('client'); ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="{{ url('/') }}"><?php echo trans('dashboard'); ?></a>
            </li>
            <li class="active">
                <strong><?php echo trans('client'); ?></strong> 
            </li>
        </ol>
    </div>
    <div class="col-lg-8">
        <div class="title-action">
            <a href="admin/add-client" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo trans('add_client'); ?> </a>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo trans('client_detail'); ?></h5>
