...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox-content  m-b-sm border-bottom">
		<div class="row">
			...
			<div class="col-sm-3">
				<label class="control-label"><?php echo trans('withdrawal_by'); ?>: </label>
...
<script>
	...
	function TableDataColums(){
		return [
		{ "title": $_lang.create_date,"class": "text-center", data : 'created_at' },
		{ "title": $_lang.withdrawal_by,"class": "text-center", data : 'pos_contact/name' },
		{ "title": $_lang.store,"class": "text-center", data : 'pos_store/store_name' },
		{ "title": $_lang.method,"class": "text-center", data : 'payment_method' },
		{ "title": $_lang.amount,"class": "text-center account_amount", data : 'amount' }, 
		{ "title": $_lang.withdraw_date,"class": "text-center", data : 'date' },
	...
	function CustomDateRangeFilter(FilterType) {
		...
		AS.Http.GetDataTable('.expense_table',TableDataColums(),{ action : "GetWithdrawalData", between_action : "created_at", from_data : start, to_data : end, date_range : true, account_for : expenseFor, store_id : businessLocation},"pos/filter/",FilterType,['account_amount']);
	}
	...
	$(document).on("click",".add_account", function(){
		$(".show_modal").remove();
		AS.Http.posthtml({"action" : "AddWithdawaAccount"}, "pos/modal/", function (data) {
