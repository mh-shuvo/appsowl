...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-4">
		<h2><?php echo trans('sales_view'); ?></h2>
		<ol class="breadcrumb">
			<li>
				<a href="pos/home"><?php echo trans('dashboard'); ?></a>
			</li>
			<li class="active">
				<strong><?php echo trans('sales_view'); ?></strong>
			</li>
		</ol>
	</div>
</div>
		...
		if(isset($this->route['id'])){
			...
			<div class="ibox-content p-xl">
						...
						<tbody class="text-center">
							<?php
								...
								<tr>
									...
									<td><?php
										$subtotal+=$value['product_subtotal'];
				...
				<div class="text-right">
					<a class="btn btn-primary print_invoice" href="pos/pdf/<?php echo $this->route['id']?>" sales_id="<?php echo $this->route['id']?>"><i class="fa fa-print"></i> <?php echo trans("print_invoice");?></a>
...
<script>
	...
	function Alert()
	{
		swal ( "Oops" ,  "No Invoice Found" ,  "error" );
	}					
